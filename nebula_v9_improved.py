"""
Nebula v9 — Modular Architecture Backward Compatibility Wrapper

This module re-exports the components from the modular package architecture:
- config.py
- licensing.py
- intents_db.py
- matcher.py
...
from config import (
    ...
    _load_cfg, _save_cfg, _init_user_files
)
...
from main import (
    Nebula, GeminiProvider, main, _add_cmd_history
)
